    ...
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row" >
            <div class="flex justify-center">
                ...
                <img src="{{ $movie['poster_path']  }}" alt="{{  $movie['title'] }}" class="w-64 md:w-123 lg:w-35">
                    ...
                    <div x-data="{ isOpen: false}">
                        @if(  $movie['video_keys'] )
                            <div class="mt-12">
                                <button
                                    @click="isOpen = true"
                                    href="https:youtube.com/watch?v={{ $movie['video_keys'] }}" class="flex inline-flex items-center justify-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 
                                    ...
                                    <div class="bg-gray-900 rounded">
                                        ...
                                        <div class="modal-body px-8 py-8">
                                            <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                                <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $movie['video_keys'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
