    ...
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row" >
            <div class="flex justify-center">
                ...
                <img src="{{ $tvshow['poster_path']  }}" alt="{{  $tvshow['name'] }}" class="w-64 md:w-123 lg:w-35">
            ...
            <div class="mt-12 md:ml-24">
                ...
                <div class="mt-12">
                    ...
                    <div x-data="{ isOpen: false}">
                        @if(  $tvshow['video_keys'] )
                            <div class="mt-12">
                                <button
                                    @click="isOpen = true"
                                    href="https:youtube.com/watch?v={{ $tvshow['video_keys'] }}" class="flex inline-flex items-center justify-center bg-orange-500 text-gray-900 rounded font-semibold px-5 py-4 
                        ...
                        @endif
                            <div
                                ...
                                class="fixed top-12 sm:top-4 lg:top-12 left-0 w-full h-full flex items-center shadow-lg overflow-y-auto "
                                x-show="isOpen"
                            >
                                    ...
                                    <div class="bg-gray-900 rounded">
                                        ...
                                        <div class="modal-body px-8 py-8">
                                            <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%">
                                                <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $tvshow['video_keys'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-3 lg:grid-cols-5 gap-8">
                @foreach($tvshow['cast'] as $cast)
                        <div class="mt-8 flex flex-col w-auto justify-center">
        ...
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8">
                @foreach($tvshow['images'] as $image)
                    <div class="mt-8 flex w-auto justify-center md:flex-none">
                        <a 
                            @click.prevent="
                                isOpen = true
